...
exports.registrarUsuario = async (req, res) => {
  ...
  try {
    ...
    const query = 'INSERT INTO usuario (nombre, apellido, funcion, usuario, password, documento) VALUES (?, ?, ?, ?, ?, ?)';
    await conexion.query(query, [nombre, apellido, funcion, usuario, hashedPassword, documento]);
